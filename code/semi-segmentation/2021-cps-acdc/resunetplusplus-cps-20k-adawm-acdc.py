...
from resnet_unet_plusplus import ResUnetPlusPlus
...
def main():
    ...
    #  网络已经进行过初始化了
    model1 = ResUnetPlusPlus(channel=1, num_classes=4).to(device)
    model2 = ResUnetPlusPlus(channel=1, num_classes=4).to(device)
