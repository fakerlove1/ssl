...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, extra, **kwargs):
        ...
        self.conv2 = nn.Conv2d(64, 64, kernel_size=(3, 3), stride=2, padding=1,
                               bias=False)
        ...
        ocr_mid_channels = extra["OCR"]["MID_CHANNELS"]
        ocr_key_channels = extra["OCR"]["KEY_CHANNELS"]
        ...
        self.ocr_gather_head = SpatialGather_Module(extra["DATASET"]["NUM_CLASSES"])
        ...
        self.cls_head = nn.Conv2d(
            ocr_mid_channels, extra["DATASET"]["NUM_CLASSES"], kernel_size=1, stride=1, padding=0, bias=True)
        ...
        self.aux_head = nn.Sequential(
            ...
            nn.ReLU(inplace=relu_inplace),
            nn.Conv2d(last_inp_channels, extra["DATASET"]["NUM_CLASSES"],
    ...
    def forward(self, x):
        ...
        # out_aux = F.interpolate(out_aux, size=(h, w),
        #                         mode='bilinear', align_corners=ALIGN_CORNERS)
        #
...
if __name__ == '__main__':
    images = torch.randn(size=(2, 3, 224,224))
    model = hrnet18()
    out = model(images)
    print(out.shape)
    # print(out[1].shape)
