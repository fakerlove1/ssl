...
def parse_args():
    ...
    # basic settings
    parser.add_argument('--data-root', type=str, default=r"E:\note\ssl\data\voc_aug_3\VOCdevkit\VOC2012")
    parser.add_argument('--dataset', type=str, choices=['pascal', 'cityscapes'], default='pascal')
    ...
    parser.add_argument('--labeled-id-path', type=str,
                        default=r"E:\note\ssl\2-Semi-Supervised-Segmentation\2022-ST++\ST-PlusPlus-master\dataset\splits\pascal\1_8\split_0\labeled.txt")
    parser.add_argument('--unlabeled-id-path', type=str,
                        default=r"E:\note\ssl\2-Semi-Supervised-Segmentation\2022-ST++\ST-PlusPlus-master\dataset\splits\pascal\1_8\split_0\unlabeled.txt")
    parser.add_argument('--pseudo-mask-path', type=str, default=r"outdir/pseudo_masks/")

    parser.add_argument('--save-path', type=str, default=r"outdir/models/")
