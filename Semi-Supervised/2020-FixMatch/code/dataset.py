...
def get_cifar10(num_labeled, num_classes, expand_labels, batch_size, eval_step, root):
...
def get_cifar100(num_labeled, num_classes, expand_labels, batch_size, eval_step, root):
    transform_labeled = transforms.Compose([
        transforms.RandomHorizontalFlip(),
        transforms.RandomCrop(size=32,
                              padding=int(32 * 0.125),
...
if __name__ == '__main__':
    ...
    train_labeled_dataset, train_unlabeled_dataset, test_dataset = \
        get_cifar10(num_labeled, num_classes, expand_labels,
                    batch_size, eval_step,
                    r"E:\note\ssl\Semi-Supervised\2017-Mean-teachers\code\data")
