...
class nnUNetTrainerV2_unet2022_acdc(nnUNetTrainer):
    """
    ...
    def do_split(self):
        ...
        #print(self.val_list)
        tr_keys = [i for i in self.dataset.keys() if i.split('_gt')[0] in self.train_list]
        val_keys = [i for i in self.dataset.keys() if i.split('_gt')[0] in self.val_list]
